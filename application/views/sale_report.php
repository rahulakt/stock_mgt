...
<!-- END PAGE BREADCRUMB -->
<!-- BEGIN MAIN CONTENT -->
<div class="row" ng-controller="SaleReportController as vm">
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption font-green-sharp">
                    <i class="icon-list font-green-sharp"></i>
                    <span class="caption-subject bold uppercase">Sale Report</span>
                    <span class="caption-helper hide"></span>
                </div>
            </div>
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form class="horizontal-form" ng-submit="vm.generateReport()" method="post" id="sale_report_form" name="vm.sale_report_form" novalidate>
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Product Name <span class="required">*</span></label>
                                    <select name="sale_product_name" ng-model="vm.sale_product_name" class="form-control select2me" select2 placeholder="Select">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date date-picker" data-date-format="dd-mm-yyyy">
                                        <input type="text" class="form-control mask_date2" name="sale_date" ng-model="vm.sale_date">
...
<script>
    ...
    ComponentsFormTools.init(); // init ComponentsFormTools page
</script>
<!-- BEGIN MAIN JS -->
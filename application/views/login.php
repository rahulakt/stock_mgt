...
<html lang="en">
    ...
    <body class=" login">
        ...
        <!-- END LOGIN -->
        <!-- BEGIN COPYRIGHT -->
        <div class="copyright"> <?php echo date('Y');?> &copy; Metronic - Invoice. </div>
        <!-- END COPYRIGHT -->
        <!--[if lt IE 9]>
...
<![endif]-->
        ...
        <script src="<?php echo base_url();?>assets/global/plugins/jquery.crypt.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
